...
<nav class="bg-gray-800">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="prd" class:bg-gray-900={currentPage === 'PRD'} class:text-white={currentPage === 'PRD'} on:click={() => setActivePage('PRD')} class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">PRD</a>
  ...
  <div class="sm:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2">
      ...
      <a href="prd" class:bg-gray-900={currentPage === 'PRD'} class:text-white={currentPage === 'PRD'} on:click={() => setActivePage('PRD')} class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">PRD</a>
      <a href="project-proposal" class:bg-gray-900={currentPage === 'Project Proposal'} class:text-white={currentPage === 'ProjectProposal'} on:click={() => setActivePage('ProjectProposal')} class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Project Proposal</a>
